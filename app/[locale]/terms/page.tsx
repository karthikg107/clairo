  ...
  return (
    <main className="min-h-screen bg-white px-5 py-10 max-w-2xl mx-auto">
      ...
      <div className="bg-warning-50 border border-warning-200 rounded-xl px-4 py-3 mb-8 text-sm text-warning-800">
        ...
        approved by legal counsel and must not be shown to users until approved. Version:
        1.0 (draft)
      </div>
      ...
      <div className="prose prose-sm max-w-none text-neutral-700 space-y-6">
        <section>
          ...
          <p>
            ...
            explain what contracts say in plain language. It does not provide legal
            advice.
          </p>
          <p>
            <strong>Clairo is not a law firm.</strong> Clairo&apos;s explanations are for
            informational purposes only. Do not rely on Clairo&apos;s output as legal
            advice. Always consult a qualified lawyer before making legal decisions.
          </p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-neutral-900 mb-2">
            2. Who can use Clairo
          </h2>
          <p>
            [LEGAL REVIEW REQUIRED — age requirements, geographic restrictions, prohibited
            uses (e.g. must not be used for unlawful purposes).]
          </p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-neutral-900 mb-2">
            3. What we do with your documents
          </h2>
          <p>Your uploaded document is processed in memory only. It is:</p>
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Sent to Anthropic for AI analysis under Anthropic&apos;s zero data retention
              policy
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            [LEGAL REVIEW REQUIRED — limitation clause, warranty disclaimer, exclusion of
            consequential loss. Must be jurisdiction-appropriate.]
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            [LEGAL REVIEW REQUIRED — who owns the analysis output; licence granted to
            user; user&apos;s IP in their uploaded documents.]
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            [LEGAL REVIEW REQUIRED — subscription tiers, auto-renewal, refund policy,
            cancellation terms.]
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            [LEGAL REVIEW REQUIRED — grounds for termination, notice period, effect on
            subscription, data deletion on termination.]
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            [LEGAL REVIEW REQUIRED — governing law and jurisdiction. Must account for EU
            consumer law mandatory protections.]
          </p>
        </section>
